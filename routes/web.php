...
Route::middleware(['auth:user'])->group(function(){
    ...
    Route::post('/panel/konfigurasi/store_set_jam_kerja', [KonfigurasiController::class, 'store_set_jam_kerja']);
    Route::post('/panel/konfigurasi/update_set_jam_kerja', [KonfigurasiController::class, 'update_set_jam_kerja']);
});
